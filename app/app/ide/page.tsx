...
export default function Page() {
    return (
        <div className="my-8 mx-16">
            ...
            <p className="font-light mt-8">We should now have arrived at a oage titled "Select Additional Tasks". The first thing to do is to choose if we want a desktop icon, a realatively straightforward step.</p>
